...
class Form
{
    ...
    public function deal()
    {
        ...
        $paragraphText = isset($_POST['paragraphText'])?htmlspecialchars(trim($_POST['paragraphText'])):null;
        $eloquaCampaignId = isset($_POST['eloquaCampaignId'])?htmlspecialchars(trim($_POST['eloquaCampaignId'])):null;
        ...
        $elqFormName = 'SelectGrowthChinaFY18Advertorial';
        ...
        if(!$firstName || !$lastName || !$busPhone || !$emailAddress || !$company || !$jobRole1 || !$industry1 || !$country || !$stateProv || !$city || !$address1 || !$eloquaCampaignId){
            die('缺少必要信息');
        }
