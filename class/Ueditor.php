...
class Ueditor
{
    ...
    public function run()
    {
        ...
        $CONFIG = json_decode(preg_replace("/\/\*[\s\S]+?\*\//", "", file_get_contents(__DIR__."/../plugin/UEditor/php/config.json")), true);
        $action = $_GET['action'];
